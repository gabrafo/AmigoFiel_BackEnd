...
public class Animal {
    ...
    public Animal(AnimalDTO animalDTO) {
        ...
        this.address = animalDTO.address();
    ...
    public Animal(String name, Specie specie, String breed, Date birthDate, char sex, double weight, Size size, boolean neutered, Address address, Date registrationDate, CurrentStatus currentStatus, Adoption adoption) {
        this.name = name;
        this.specie = specie;
        this.breed = breed;
